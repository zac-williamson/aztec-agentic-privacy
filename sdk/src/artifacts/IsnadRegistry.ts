...
credentials: {
  ...
  public declare methods: {
    ...
    /** __aztec_nr_internals__attest(skill_hash: field, quality: integer, claim_type: integer) */
    __aztec_nr_internals__attest: ((skill_hash: FieldLike, quality: (bigint | number), claim_type: (bigint | number)) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

...
export const ArchiverApiSchema = {
    ...
    getCheckpointedBlocks: z.function().args(BlockNumberSchema, schemas.Integer).returns(z.array(CheckpointedL2Block.schema)),
    getBlocks: z.function().args(BlockNumberSchema, schemas.Integer).returns(z.array(L2Block.schema)),
    getCheckpoints: z.function().args(CheckpointNumberSchema, schemas.Integer).returns(z.array(PublishedCheckpoint.schema)),
    ...
    getPrivateLogsByTags: z.function().args(z.array(SiloedTag.schema), optional(z.number().gte(0))).returns(z.array(z.array(TxScopedL2Log.schema))),
    getPublicLogsByTagsFromContract: z.function().args(schemas.AztecAddress, z.array(Tag.schema), optional(z.number().gte(0))).returns(z.array(z.array(TxScopedL2Log.schema))),

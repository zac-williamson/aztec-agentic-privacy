 ...
 */ export async function getSchnorrAccountContractArtifact() {
    ...
    // Patched: added import attribute for Node.js compatibility
    const { default: schnorrAccountContractJson } = await import('../../artifacts/SchnorrAccount.json', { with: { type: 'json' } });

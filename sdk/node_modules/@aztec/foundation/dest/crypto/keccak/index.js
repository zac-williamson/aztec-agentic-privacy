 ...
 */ export function keccakf1600(state) {
    ...
    /* The implementation based on the "simple" implementation by Ronny Van Keer. */ /* Adapted from Barretenberg's CPP implementation. */ let Eba, Ebe, Ebi, Ebo, Ebu;
    ...
    for(let round = 0; round < 24; round += 2){
        /* Round (round + 0): Axx -> Exx */ Ba = Aba ^ Aga ^ Aka ^ Ama ^ Asa;
        ...
        Eso = Bo ^ ~Bu & Ba;
        Esu = Bu ^ ~Ba & Be;
        /* Round (round + 1): Exx -> Axx */ Ba = Eba ^ Ega ^ Eka ^ Ema ^ Esa;

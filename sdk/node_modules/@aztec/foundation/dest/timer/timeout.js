 ...
 */ export class TimeoutTask {
    ...
    totalTime;
    timeoutPromise;
    constructor(fn, timeout, errorFn, onAbort){
        this.fn = fn;
 ...
 *
 * */ export async function executeTimeout(fn, timeout, errorOrFnName, onAbort) {
...
/** Returns a promise that rejects after the given timeout */ export function timeoutPromise(timeoutMs, errorMessage) {

 ...
 */ export class TestNote {
    ...
    static get schema() {
        return z.object({
            data: z.string()
        }).transform(({ data })=>new TestNote(data));
    }
    toJSON() {
        return {
            data: this.data
 ...
 */ export class TestState {
   ...
   */ async addNotes(notes) {
    ...
    async getStatus() {
        ...
        return {
            status: 'ok',
            count: BigInt(this.notes.length)
        };
    }
    async getTuple() {
        await sleep(0.1);
...
export const TestStateSchema = {
    ...
    getStatus: z.function().returns(z.object({
        status: z.string(),
        count: schemas.BigInt
    })),
    getTuple: z.function().returns(z.tuple([
        z.string(),
        optional(z.string()),
        z.number()
    ]))

import { BLOCK_MERGE_ROLLUP_VK_INDEX, BLOCK_ROOT_EMPTY_TX_FIRST_ROLLUP_VK_INDEX, BLOCK_ROOT_FIRST_ROLLUP_VK_INDEX, BLOCK_ROOT_ROLLUP_VK_INDEX, BLOCK_ROOT_SINGLE_TX_FIRST_ROLLUP_VK_INDEX, BLOCK_ROOT_SINGLE_TX_ROLLUP_VK_INDEX, CHECKPOINT_MERGE_ROLLUP_VK_INDEX, CHECKPOINT_PADDING_ROLLUP_VK_INDEX, CHECKPOINT_ROOT_ROLLUP_VK_INDEX, CHECKPOINT_ROOT_SINGLE_BLOCK_ROLLUP_VK_INDEX, HIDING_KERNEL_TO_PUBLIC_VK_INDEX, HIDING_KERNEL_TO_ROLLUP_VK_INDEX, PARITY_BASE_VK_INDEX, PARITY_ROOT_VK_INDEX, PRIVATE_KERNEL_INIT_VK_INDEX, PRIVATE_KERNEL_INNER_VK_INDEX, PRIVATE_KERNEL_TAIL_TO_PUBLIC_VK_INDEX, PRIVATE_KERNEL_TAIL_VK_INDEX, PRIVATE_TX_BASE_ROLLUP_VK_INDEX, PUBLIC_CHONK_VERIFIER_VK_INDEX, PUBLIC_TX_BASE_ROLLUP_VK_INDEX, ROOT_ROLLUP_VK_INDEX, TX_MERGE_ROLLUP_VK_INDEX } from '@aztec/constants';
import PublicChonkVerifier from '../../../artifacts/chonk_verifier_public.json' with {
    type: 'json'
};
import ParityBase from '../../../artifacts/parity_base.json' with {
    type: 'json'
};
import ParityRoot from '../../../artifacts/parity_root.json' with {
    type: 'json'
};
import BlockMergeRollup from '../../../artifacts/rollup_block_merge.json' with {
    type: 'json'
};
import BlockRootRollup from '../../../artifacts/rollup_block_root.json' with {
    type: 'json'
};
import BlockRootFirstRollup from '../../../artifacts/rollup_block_root_first.json' with {
    type: 'json'
};
import BlockRootEmptyTxFirstRollup from '../../../artifacts/rollup_block_root_first_empty_tx.json' with {
    type: 'json'
};
import BlockRootSingleTxFirstRollup from '../../../artifacts/rollup_block_root_first_single_tx.json' with {
    type: 'json'
};
import BlockRootSingleTxRollup from '../../../artifacts/rollup_block_root_single_tx.json' with {
    type: 'json'
};
import CheckpointMergeRollup from '../../../artifacts/rollup_checkpoint_merge.json' with {
    type: 'json'
};
import CheckpointPaddingRollup from '../../../artifacts/rollup_checkpoint_padding.json' with {
    type: 'json'
};
import CheckpointRootRollup from '../../../artifacts/rollup_checkpoint_root.json' with {
    type: 'json'
};
import CheckpointRootSingleBlockRollup from '../../../artifacts/rollup_checkpoint_root_single_block.json' with {
    type: 'json'
};
import RootRollup from '../../../artifacts/rollup_root.json' with {
    type: 'json'
};
import PrivateTxBaseRollup from '../../../artifacts/rollup_tx_base_private.json' with {
    type: 'json'
};
import PublicTxBaseRollup from '../../../artifacts/rollup_tx_base_public.json' with {
    type: 'json'
};
import TxMergeRollup from '../../../artifacts/rollup_tx_merge.json' with {
    type: 'json'
};
import { PrivateKernelResetVkIndexes } from '../../private_kernel_reset_vks.js';
import { abiToVKData } from '../../utils/vk_json.js';
export const ServerCircuitVks = {
...
export const ProtocolCircuitVkIndexes = {

 ...
 */ export const RewardExtLibAbi = [
    ...
    {
        "type": "error",
        "name": "EscapeHatch__HatchTooEarly",
        "inputs": [
            {
                "name": "hatch",
                "type": "uint256",
    ...
    {
        "type": "error",
        "name": "TallySlashingProposer__SlashAmountMustBeGtZero",
        "inputs": [
            {
                "name": "info",
                "type": "string",
    ...
    {
        "type": "function",
        "name": "getEthPerFeeAssetAtCheckpoint",
        "inputs": [
            {
                "name": "_checkpointNumber",
                "type": "uint256",
        ...
        "outputs": [
            {
                "name": "",
                "type": "uint256",
                "internalType": "EthPerFeeAssetE12"
            }
        ],
        "stateMutability": "view"
    },
        ...
        "inputs": [
            {
                "name": "_components",
                "type": "tuple",
                "internalType": "struct ManaMinFeeComponents",
                "components": [
                    {
                        "name": "congestionCost",
                        "type": "uint256",
    ...
    {
        "type": "function",
        "name": "getManaMinFeeComponentsAt",
        "inputs": [
            {
                "name": "_timestamp",
                "type": "uint256",
    ...
    {
        "type": "error",
        "name": "FeeLib__InvalidInitialEthPerFeeAsset",
        "inputs": [
            {
                "name": "provided",
                "type": "uint256",

...
/** The checkpoint number */ export const CHECKPOINT_NUMBER = 'aztec.checkpoint.number';
...
/** The state of a peer (Healthy, Disconnect, Banned) */ export const P2P_PEER_SCORE_STATE = 'aztec.p2p.peer_score_state';
...
/** The reason a transaction was evicted from the tx pool */ export const TX_POOL_EVICTION_REASON = 'aztec.mempool.eviction_reason';
...
/** Fisherman fee analysis strategy identifier */ export const FISHERMAN_FEE_STRATEGY_ID = 'aztec.fisherman.strategy_id';
/** Whether the analyzed block reached 100% blob capacity */ export const BLOCK_FULL = 'aztec.block_full';
/** The L1 transaction target for block proposal */ export const L1_BLOCK_PROPOSAL_TX_TARGET = 'aztec.l1.block_proposal_tx_target';
/** Whether tracing methods were used to extract block proposal data */ export const L1_BLOCK_PROPOSAL_USED_TRACE = 'aztec.l1.block_proposal_used_trace';

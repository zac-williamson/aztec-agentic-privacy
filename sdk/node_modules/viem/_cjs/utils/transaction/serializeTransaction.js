...
const getBlobVersion_js_1 = require("../blob/getBlobVersion.js");
...
function serializeTransactionEIP4844(transaction, signature) {
    const { chainId, gas, nonce, to, value, maxFeePerBlobGas, maxFeePerGas, maxPriorityFeePerGas, accessList, data, blobVersion: explicitBlobVersion, } = transaction;
    (0, assertTransaction_js_1.assertTransactionEIP4844)(transaction);
    const blobVersion = (0, getBlobVersion_js_1.getBlobVersion)({
        chainId,
    ...
    if (transaction.blobs &&
        ...
        if (typeof sidecars === 'undefined') {
            const proofs = (0, blobsToProofs_js_1.blobsToProofs)({ blobs, commitments, kzg, blobVersion });
    ...
    if (blobVersion === '7594') {
        return (0, concat_js_1.concatHex)([
            ...
            sidecars
                ?
                    (0, toRlp_js_1.toRlp)([serializedTransaction, '0x01', blobs, commitments, proofs])
                :
